...
class TestProducts(unittest.TestCase):
    ...
    def test_3_edit_product(self):
        created_product = create_product("House Insurance", "Whether you are looking to protect your car, we are here to help you plan your future. Our individual, retail and corporate clients enjoy an extensive line of products and services in all insurance business lines, designed to protect them against risks.", 200.0, 1)
        print(created_product)
        edited_product = edit_product("Car Insurance", "Whether you are looking to protect your life, we are here to help you plan your future. Our individual, retail and corporate clients enjoy an extensive line of products and services in all insurance business lines, designed to protect them against risks.", 70.0, 1, 5)
        print(edited_product)
        product = get_product(5)
        print(product)
        self.assertEqual(product["name"], "Car Insurance")
